  ...
  <xsl:template match="/">
    <html lang="en">
      ...
      <body>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>Vulny Scan Report<br/><small>By Ninpo Inc.</small></h1>
            <p class="lead">
        ...
        <footer class="footer">
          <div class="container">
            <p class="text-muted">
              This report was generated by <a href="https://www.ninpo.com">Ninpo Inc.</a> All Rights Reserved.<br/>
              For any questions, contact us at <a href="mailto:support@ninpo.com">support@ninpo.com</a>.
            </p>
          </div>
        </footer>
      </body>
